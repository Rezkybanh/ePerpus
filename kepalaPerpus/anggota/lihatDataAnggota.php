...
if (isset($_GET['search'])) {
    ...
    $query = "SELECT * FROM anggota 
              WHERE (nama LIKE :search OR nisnip LIKE :search OR kelas_unit LIKE :search)";
...
if (isset($_POST['action']) && $_POST['action'] == 'update') {
    ...
    if ($isValid) {
        ...
        $stmt->bindValue(':kelas_unit', $kelas_unit, PDO::PARAM_STR);
        $stmt->bindValue(':kontak', $kontak, PDO::PARAM_STR);
...
if (isset($_POST['action']) && $_POST['action'] == 'delete') {
    $id = $_POST['id'];
    $deleteQuery = "DELETE FROM anggota WHERE id_anggota = :id";
