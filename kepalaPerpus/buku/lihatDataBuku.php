...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $query = "SELECT * FROM buku WHERE (judul LIKE :search OR pengarang LIKE :search OR penerbit LIKE :search OR isbn LIKE :search)";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update') {
    ...
    if (
        ...
        $updateQuery = "UPDATE buku SET judul = :judul, pengarang = :pengarang, penerbit = :penerbit, tahun_terbit = :tahun_terbit, isbn = :isbn, stok = :stok WHERE id_buku = :id";
